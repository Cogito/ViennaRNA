...
#define  SWIGTYPE_p_cpair swig_types[4] 
#define  SWIGTYPE_p_swString swig_types[5] 
#define  SWIGTYPE_p_float swig_types[6] 
#define  SWIGTYPE_p_void swig_types[7] 
#define  SWIGTYPE_p_floatArray swig_types[8] 
...
#define  SWIGTYPE_p_paramT swig_types[15] 
#define  SWIGTYPE_p_Tree swig_types[16] 
#define  SWIGTYPE_p_FILE swig_types[17] 
#define  SWIGTYPE_p_bondT swig_types[18] 
...
XS(_wrap_bond_i_set) {
    ...
    const char *_swigerr = _swigmsg;
    {
        ...
        if ((items < 2) || (items > 2)) {
            SWIG_croak("Usage: bond_i_set(self,i);");
        }
        {
            if (SWIG_ConvertPtr(ST(0), (void **) &arg1, SWIGTYPE_p_bond,0) < 0) {
                SWIG_croak("Type error in argument 1 of bond_i_set. Expected _p_bond");
            }
        }
        arg2 = (int) SvIV(ST(1));
        if (arg1) (arg1)->i = arg2;
...
XS(_wrap_bond_i_get) {
    ...
    const char *_swigerr = _swigmsg;
    {
        ...
        if ((items < 1) || (items > 1)) {
            SWIG_croak("Usage: bond_i_get(self);");
        }
        {
            if (SWIG_ConvertPtr(ST(0), (void **) &arg1, SWIGTYPE_p_bond,0) < 0) {
                SWIG_croak("Type error in argument 1 of bond_i_get. Expected _p_bond");
            }
        }
        result = (int) ((arg1)->i);
...
XS(_wrap_bond_j_set) {
    ...
    const char *_swigerr = _swigmsg;
    {
        ...
        if ((items < 2) || (items > 2)) {
            SWIG_croak("Usage: bond_j_set(self,j);");
        }
        {
            if (SWIG_ConvertPtr(ST(0), (void **) &arg1, SWIGTYPE_p_bond,0) < 0) {
                SWIG_croak("Type error in argument 1 of bond_j_set. Expected _p_bond");
            }
        }
        arg2 = (int) SvIV(ST(1));
        if (arg1) (arg1)->j = arg2;
...
XS(_wrap_bond_j_get) {
    ...
    const char *_swigerr = _swigmsg;
    {
        ...
        if ((items < 1) || (items > 1)) {
            SWIG_croak("Usage: bond_j_get(self);");
        }
        {
            if (SWIG_ConvertPtr(ST(0), (void **) &arg1, SWIGTYPE_p_bond,0) < 0) {
                SWIG_croak("Type error in argument 1 of bond_j_get. Expected _p_bond");
            }
        }
        result = (int) ((arg1)->j);
...
XS(_wrap_new_bond) {
    ...
    const char *_swigerr = _swigmsg;
    {
        ...
        if ((items < 0) || (items > 0)) {
            SWIG_croak("Usage: new_bond();");
        }
        result = (struct bond *)(struct bond *) calloc(1, sizeof(struct bond));
        
        ST(argvi) = sv_newmortal();
        SWIG_MakePtr(ST(argvi++), (void *) result, SWIGTYPE_p_bond,0);
        XSRETURN(argvi);
        fail:
        (void) _swigerr;
    }
...
XS(_wrap_delete_bond) {
    ...
    const char *_swigerr = _swigmsg;
    {
        ...
        if ((items < 1) || (items > 1)) {
            SWIG_croak("Usage: delete_bond(self);");
        }
        {
            if (SWIG_ConvertPtr(ST(0), (void **) &arg1, SWIGTYPE_p_bond,0) < 0) {
                SWIG_croak("Type error in argument 1 of delete_bond. Expected _p_bond");
            }
        }
        free((char *) arg1);
...
static swig_type_info _swigt__p_bond[] = {{"RNA::bond", 0, "bond *", 0},{"_p_bondT"},{"RNA::bond"},{0}};
...
static swig_type_info _swigt__p_bondT[] = {{"_p_bondT", 0, "bondT *", 0},{"_p_bondT"},{"RNA::bond"},{0}};
...
{"RNAc::bond_i_set", _wrap_bond_i_set},
{"RNAc::bond_i_get", _wrap_bond_i_get},
{"RNAc::bond_j_set", _wrap_bond_j_set},
{"RNAc::bond_j_get", _wrap_bond_j_get},
{"RNAc::new_bond", _wrap_new_bond},
{"RNAc::delete_bond", _wrap_delete_bond},
...
XS(SWIG_init) {
    ...
    SWIG_TypeClientData(SWIGTYPE_p_bond, (void*) "RNA::bond");
