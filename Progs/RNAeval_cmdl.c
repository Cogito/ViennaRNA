...
init_help_array(void)
{
  ...
  RNAeval_args_info_help[9] = RNAeval_args_info_detailed_help[9];
  RNAeval_args_info_help[10] = RNAeval_args_info_detailed_help[10];
  RNAeval_args_info_help[11] = RNAeval_args_info_detailed_help[12];
  RNAeval_args_info_help[12] = RNAeval_args_info_detailed_help[13];
  RNAeval_args_info_help[13] = RNAeval_args_info_detailed_help[15];
  RNAeval_args_info_help[14] = RNAeval_args_info_detailed_help[16];
  RNAeval_args_info_help[15] = RNAeval_args_info_detailed_help[17];
  RNAeval_args_info_help[16] = RNAeval_args_info_detailed_help[19];
  RNAeval_args_info_help[17] = 0; 
  
}

const char *RNAeval_args_info_help[18];
...
void init_args_info(struct RNAeval_args_info *args_info)
{
  ...
  args_info->version_help = RNAeval_args_info_detailed_help[2] ;
  args_info->noconv_help = RNAeval_args_info_detailed_help[5] ;
  args_info->verbose_help = RNAeval_args_info_detailed_help[6] ;
  args_info->temp_help = RNAeval_args_info_detailed_help[8] ;
  args_info->noTetra_help = RNAeval_args_info_detailed_help[9] ;
  args_info->dangles_help = RNAeval_args_info_detailed_help[10] ;
  args_info->energyModel_help = RNAeval_args_info_detailed_help[12] ;
  args_info->paramFile_help = RNAeval_args_info_detailed_help[13] ;
  args_info->circ_help = RNAeval_args_info_detailed_help[15] ;
  args_info->gquad_help = RNAeval_args_info_detailed_help[16] ;
  args_info->logML_help = RNAeval_args_info_detailed_help[17] ;
