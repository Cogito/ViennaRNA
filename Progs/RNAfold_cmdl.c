...
init_full_help_array(void)
{
  ...
  RNAfold_args_info_full_help[21] = RNAfold_args_info_detailed_help[28];
  RNAfold_args_info_full_help[22] = RNAfold_args_info_detailed_help[30];
...
const char *RNAfold_args_info_help[24];
...
void init_args_info(struct RNAfold_args_info *args_info)
{
  ...
  args_info->temp_help = RNAfold_args_info_detailed_help[24] ;
  args_info->noTetra_help = RNAfold_args_info_detailed_help[25] ;
  args_info->dangles_help = RNAfold_args_info_detailed_help[26] ;
  args_info->noLP_help = RNAfold_args_info_detailed_help[28] ;
  args_info->noGU_help = RNAfold_args_info_detailed_help[30] ;
  args_info->noClosingGU_help = RNAfold_args_info_detailed_help[31] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVCp::S:cT:4d:P:e:", long_options, &option_index);
