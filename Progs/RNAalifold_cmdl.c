...
init_full_help_array(void)
{
  ...
  RNAalifold_args_info_full_help[13] = RNAalifold_args_info_detailed_help[15];
  RNAalifold_args_info_full_help[14] = RNAalifold_args_info_detailed_help[17];
  ...
  RNAalifold_args_info_full_help[18] = RNAalifold_args_info_detailed_help[22];
  RNAalifold_args_info_full_help[19] = RNAalifold_args_info_detailed_help[23];
  RNAalifold_args_info_full_help[20] = RNAalifold_args_info_detailed_help[25];
  ...
  RNAalifold_args_info_full_help[24] = RNAalifold_args_info_detailed_help[30];
  RNAalifold_args_info_full_help[25] = RNAalifold_args_info_detailed_help[32];
  RNAalifold_args_info_full_help[26] = RNAalifold_args_info_detailed_help[33];
  RNAalifold_args_info_full_help[27] = RNAalifold_args_info_detailed_help[34];
...
init_help_array(void)
{
  ...
  RNAalifold_args_info_help[10] = RNAalifold_args_info_detailed_help[11];
  RNAalifold_args_info_help[11] = RNAalifold_args_info_detailed_help[12];
  RNAalifold_args_info_help[12] = RNAalifold_args_info_detailed_help[13];
  RNAalifold_args_info_help[13] = RNAalifold_args_info_detailed_help[15];
  RNAalifold_args_info_help[14] = RNAalifold_args_info_detailed_help[17];
  RNAalifold_args_info_help[15] = RNAalifold_args_info_detailed_help[18];
  RNAalifold_args_info_help[16] = RNAalifold_args_info_detailed_help[19];
  RNAalifold_args_info_help[17] = RNAalifold_args_info_detailed_help[22];
  RNAalifold_args_info_help[18] = RNAalifold_args_info_detailed_help[25];
  RNAalifold_args_info_help[19] = RNAalifold_args_info_detailed_help[26];
  RNAalifold_args_info_help[20] = RNAalifold_args_info_detailed_help[27];
  RNAalifold_args_info_help[21] = RNAalifold_args_info_detailed_help[28];
  RNAalifold_args_info_help[22] = RNAalifold_args_info_detailed_help[30];
  RNAalifold_args_info_help[23] = RNAalifold_args_info_detailed_help[32];
  RNAalifold_args_info_help[24] = RNAalifold_args_info_detailed_help[33];
  RNAalifold_args_info_help[25] = RNAalifold_args_info_detailed_help[34];
  RNAalifold_args_info_help[26] = RNAalifold_args_info_detailed_help[35];
  RNAalifold_args_info_help[27] = RNAalifold_args_info_detailed_help[36];
  RNAalifold_args_info_help[28] = RNAalifold_args_info_detailed_help[37];
...
const char *RNAalifold_args_info_help[34];
...
void init_args_info(struct RNAalifold_args_info *args_info)
{
  ...
  args_info->partfunc_help = RNAalifold_args_info_detailed_help[13] ;
  args_info->MEA_help = RNAalifold_args_info_detailed_help[15] ;
  args_info->mis_help = RNAalifold_args_info_detailed_help[17] ;
  args_info->stochBT_help = RNAalifold_args_info_detailed_help[18] ;
  args_info->stochBT_en_help = RNAalifold_args_info_detailed_help[19] ;
  args_info->pfScale_help = RNAalifold_args_info_detailed_help[20] ;
  args_info->circ_help = RNAalifold_args_info_detailed_help[22] ;
  args_info->bppmThreshold_help = RNAalifold_args_info_detailed_help[23] ;
  args_info->temp_help = RNAalifold_args_info_detailed_help[26] ;
  args_info->noTetra_help = RNAalifold_args_info_detailed_help[27] ;
  args_info->dangles_help = RNAalifold_args_info_detailed_help[28] ;
  args_info->noLP_help = RNAalifold_args_info_detailed_help[30] ;
  args_info->noGU_help = RNAalifold_args_info_detailed_help[32] ;
  args_info->noClosingGU_help = RNAalifold_args_info_detailed_help[33] ;
  args_info->cfactor_help = RNAalifold_args_info_detailed_help[34] ;
  args_info->nfactor_help = RNAalifold_args_info_detailed_help[35] ;
  args_info->endgaps_help = RNAalifold_args_info_detailed_help[36] ;
  args_info->ribosum_file_help = RNAalifold_args_info_detailed_help[37] ;
  args_info->ribosum_scoring_help = RNAalifold_args_info_detailed_help[38] ;
  args_info->old_help = RNAalifold_args_info_detailed_help[39] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVCp::s:S:cT:4d:ER:rP:e:", long_options, &option_index);
