/*
  ...
  gengetopt -i RNALalifold.ggo --file-name=RNALalifold_cmdl --include-getopt --default-optional --unamed-opts --func-name=RNALalifold_cmdline_parser --arg-struct-name=RNALalifold_args_info
...
init_full_help_array(void)
{
  ...
  RNALalifold_args_info_full_help[6] = RNALalifold_args_info_detailed_help[6];
  RNALalifold_args_info_full_help[7] = RNALalifold_args_info_detailed_help[7];
  RNALalifold_args_info_full_help[8] = RNALalifold_args_info_detailed_help[8];
  RNALalifold_args_info_full_help[9] = RNALalifold_args_info_detailed_help[9];
  RNALalifold_args_info_full_help[10] = RNALalifold_args_info_detailed_help[10];
  RNALalifold_args_info_full_help[11] = RNALalifold_args_info_detailed_help[12];
  RNALalifold_args_info_full_help[12] = RNALalifold_args_info_detailed_help[13];
  RNALalifold_args_info_full_help[13] = RNALalifold_args_info_detailed_help[15];
  RNALalifold_args_info_full_help[14] = RNALalifold_args_info_detailed_help[16];
  RNALalifold_args_info_full_help[15] = RNALalifold_args_info_detailed_help[17];
  RNALalifold_args_info_full_help[16] = RNALalifold_args_info_detailed_help[18];
  RNALalifold_args_info_full_help[17] = RNALalifold_args_info_detailed_help[19];
  RNALalifold_args_info_full_help[18] = RNALalifold_args_info_detailed_help[21];
  RNALalifold_args_info_full_help[19] = RNALalifold_args_info_detailed_help[23];
  RNALalifold_args_info_full_help[20] = RNALalifold_args_info_detailed_help[24];
  RNALalifold_args_info_full_help[21] = RNALalifold_args_info_detailed_help[25];
  RNALalifold_args_info_full_help[22] = RNALalifold_args_info_detailed_help[27];
  RNALalifold_args_info_full_help[23] = RNALalifold_args_info_detailed_help[29];
  RNALalifold_args_info_full_help[24] = RNALalifold_args_info_detailed_help[30];
  RNALalifold_args_info_full_help[25] = RNALalifold_args_info_detailed_help[31];
  RNALalifold_args_info_full_help[26] = RNALalifold_args_info_detailed_help[32];
  RNALalifold_args_info_full_help[27] = RNALalifold_args_info_detailed_help[33];
  RNALalifold_args_info_full_help[28] = RNALalifold_args_info_detailed_help[34];
  RNALalifold_args_info_full_help[29] = 0; 
  
}

const char *RNALalifold_args_info_full_help[30];
...
init_help_array(void)
{
  ...
  RNALalifold_args_info_help[6] = RNALalifold_args_info_detailed_help[6];
  RNALalifold_args_info_help[7] = RNALalifold_args_info_detailed_help[7];
  RNALalifold_args_info_help[8] = RNALalifold_args_info_detailed_help[8];
  RNALalifold_args_info_help[9] = RNALalifold_args_info_detailed_help[9];
  RNALalifold_args_info_help[10] = RNALalifold_args_info_detailed_help[10];
  RNALalifold_args_info_help[11] = RNALalifold_args_info_detailed_help[12];
  RNALalifold_args_info_help[12] = RNALalifold_args_info_detailed_help[15];
  RNALalifold_args_info_help[13] = RNALalifold_args_info_detailed_help[16];
  RNALalifold_args_info_help[14] = RNALalifold_args_info_detailed_help[17];
  RNALalifold_args_info_help[15] = RNALalifold_args_info_detailed_help[18];
  RNALalifold_args_info_help[16] = RNALalifold_args_info_detailed_help[19];
  RNALalifold_args_info_help[17] = RNALalifold_args_info_detailed_help[21];
  RNALalifold_args_info_help[18] = RNALalifold_args_info_detailed_help[23];
  RNALalifold_args_info_help[19] = RNALalifold_args_info_detailed_help[24];
  RNALalifold_args_info_help[20] = RNALalifold_args_info_detailed_help[25];
  RNALalifold_args_info_help[21] = RNALalifold_args_info_detailed_help[30];
  RNALalifold_args_info_help[22] = RNALalifold_args_info_detailed_help[31];
  RNALalifold_args_info_help[23] = RNALalifold_args_info_detailed_help[32];
  RNALalifold_args_info_help[24] = RNALalifold_args_info_detailed_help[33];
  RNALalifold_args_info_help[25] = RNALalifold_args_info_detailed_help[34];
  RNALalifold_args_info_help[26] = 0; 
  
}

const char *RNALalifold_args_info_help[27];
...
void init_args_info(struct RNALalifold_args_info *args_info)
{
  ...
  args_info->span_help = RNALalifold_args_info_detailed_help[6] ;
  args_info->csv_help = RNALalifold_args_info_detailed_help[7] ;
  args_info->partfunc_help = RNALalifold_args_info_detailed_help[10] ;
  args_info->cutoff_help = RNALalifold_args_info_detailed_help[12] ;
  args_info->pfScale_help = RNALalifold_args_info_detailed_help[13] ;
  args_info->mis_help = RNALalifold_args_info_detailed_help[15] ;
  args_info->temp_help = RNALalifold_args_info_detailed_help[17] ;
  args_info->noTetra_help = RNALalifold_args_info_detailed_help[18] ;
  args_info->dangles_help = RNALalifold_args_info_detailed_help[19] ;
  args_info->noLP_help = RNALalifold_args_info_detailed_help[21] ;
  args_info->noGU_help = RNALalifold_args_info_detailed_help[23] ;
  args_info->noClosingGU_help = RNALalifold_args_info_detailed_help[24] ;
  args_info->paramFile_help = RNALalifold_args_info_detailed_help[25] ;
  args_info->nsp_help = RNALalifold_args_info_detailed_help[27] ;
  args_info->energyModel_help = RNALalifold_args_info_detailed_help[29] ;
  args_info->cfactor_help = RNALalifold_args_info_detailed_help[30] ;
  args_info->nfactor_help = RNALalifold_args_info_detailed_help[31] ;
  args_info->ribosum_file_help = RNALalifold_args_info_detailed_help[32] ;
  args_info->ribosum_scoring_help = RNALalifold_args_info_detailed_help[33] ;
...
static void print_help_common(void) {
  ...
  if (strlen(RNALalifold_args_info_purpose) > 0)
    printf("\n%s\n", RNALalifold_args_info_purpose);

  if (strlen(RNALalifold_args_info_usage) > 0)
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVL:p::c:S:T:4d:P:e:R:r", long_options, &option_index);
...
.  */
          ...
          if (update_arg( (void *)&(args_info->span_arg), 
              ...
              &(local_args_info.span_given), optarg, 0, "70", ARG_INT,
          ...
          break;
        case 'p':	/* Calculate the partition function and base pairing probability matrix in addition to the mfe structure..  */
