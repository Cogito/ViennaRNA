...
init_full_help_array(void)
{
  ...
  RNAalifold_args_info_full_help[26] = RNAalifold_args_info_detailed_help[32];
  ...
  RNAalifold_args_info_full_help[36] = RNAalifold_args_info_detailed_help[44];
  RNAalifold_args_info_full_help[37] = RNAalifold_args_info_detailed_help[46];
  RNAalifold_args_info_full_help[38] = RNAalifold_args_info_detailed_help[47];
  RNAalifold_args_info_full_help[39] = RNAalifold_args_info_detailed_help[49];
  RNAalifold_args_info_full_help[40] = 0; 
  
}

const char *RNAalifold_args_info_full_help[41];
...
init_help_array(void)
{
  ...
  RNAalifold_args_info_help[24] = RNAalifold_args_info_detailed_help[34];
  ...
  RNAalifold_args_info_help[33] = RNAalifold_args_info_detailed_help[49];
  RNAalifold_args_info_help[34] = 0; 
  
}

const char *RNAalifold_args_info_help[35];
...
void init_args_info(struct RNAalifold_args_info *args_info)
{
  ...
  args_info->temp_help = RNAalifold_args_info_detailed_help[28] ;
  args_info->noTetra_help = RNAalifold_args_info_detailed_help[29] ;
  args_info->dangles_help = RNAalifold_args_info_detailed_help[30] ;
  args_info->noLP_help = RNAalifold_args_info_detailed_help[32] ;
  args_info->noGU_help = RNAalifold_args_info_detailed_help[34] ;
  args_info->noClosingGU_help = RNAalifold_args_info_detailed_help[35] ;
  args_info->cfactor_help = RNAalifold_args_info_detailed_help[36] ;
  args_info->nfactor_help = RNAalifold_args_info_detailed_help[37] ;
  args_info->endgaps_help = RNAalifold_args_info_detailed_help[38] ;
  args_info->ribosum_file_help = RNAalifold_args_info_detailed_help[39] ;
  args_info->ribosum_scoring_help = RNAalifold_args_info_detailed_help[40] ;
  args_info->old_help = RNAalifold_args_info_detailed_help[41] ;
  args_info->paramFile_help = RNAalifold_args_info_detailed_help[42] ;
  args_info->nsp_help = RNAalifold_args_info_detailed_help[44] ;
  args_info->energyModel_help = RNAalifold_args_info_detailed_help[46] ;
  args_info->betaScale_help = RNAalifold_args_info_detailed_help[47] ;
