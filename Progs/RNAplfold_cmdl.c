/*
  ...
  gengetopt -i RNAplfold.ggo --file-name=RNAplfold_cmdl --include-getopt --default-optional --func-name=RNAplfold_cmdline_parser --arg-struct-name=RNAplfold_args_info
...
const char *RNAplfold_args_info_usage = "Usage: RNAplfold [OPTIONS]...";
...
const char *RNAplfold_args_info_detailed_help[] = {
  ...
  "  -L, --span=size            Set the maximum allowed separation of a base pair \n                               to span. I.e. no pairs (i,j) with j-i > span \n                               will be allowed. Defaults to winsize if \n                               parameter is omitted\n                               \n",
  "  -c, --cutoff=FLOAT         Report only base pairs with an average probability \n                               > cutoff in the dot plot\n                               \n                                 (default=`0.01')",
...
init_full_help_array(void)
{
  ...
  RNAplfold_args_info_full_help[9] = RNAplfold_args_info_detailed_help[9];
  RNAplfold_args_info_full_help[10] = RNAplfold_args_info_detailed_help[10];
  RNAplfold_args_info_full_help[11] = RNAplfold_args_info_detailed_help[11];
  RNAplfold_args_info_full_help[12] = RNAplfold_args_info_detailed_help[12];
  RNAplfold_args_info_full_help[13] = RNAplfold_args_info_detailed_help[13];
  RNAplfold_args_info_full_help[14] = RNAplfold_args_info_detailed_help[14];
  RNAplfold_args_info_full_help[15] = RNAplfold_args_info_detailed_help[15];
  RNAplfold_args_info_full_help[16] = RNAplfold_args_info_detailed_help[16];
  RNAplfold_args_info_full_help[17] = RNAplfold_args_info_detailed_help[17];
  RNAplfold_args_info_full_help[18] = RNAplfold_args_info_detailed_help[19];
  RNAplfold_args_info_full_help[19] = RNAplfold_args_info_detailed_help[21];
  RNAplfold_args_info_full_help[20] = RNAplfold_args_info_detailed_help[22];
  RNAplfold_args_info_full_help[21] = RNAplfold_args_info_detailed_help[23];
  RNAplfold_args_info_full_help[22] = RNAplfold_args_info_detailed_help[25];
...
init_help_array(void)
{
  ...
  RNAplfold_args_info_help[9] = RNAplfold_args_info_detailed_help[9];
  RNAplfold_args_info_help[10] = RNAplfold_args_info_detailed_help[10];
  RNAplfold_args_info_help[11] = RNAplfold_args_info_detailed_help[11];
  RNAplfold_args_info_help[12] = RNAplfold_args_info_detailed_help[13];
  RNAplfold_args_info_help[13] = RNAplfold_args_info_detailed_help[14];
  RNAplfold_args_info_help[14] = RNAplfold_args_info_detailed_help[15];
  RNAplfold_args_info_help[15] = RNAplfold_args_info_detailed_help[16];
  RNAplfold_args_info_help[16] = RNAplfold_args_info_detailed_help[17];
  RNAplfold_args_info_help[17] = RNAplfold_args_info_detailed_help[19];
  RNAplfold_args_info_help[18] = RNAplfold_args_info_detailed_help[21];
...
const char *RNAplfold_args_info_help[24];
...
void init_args_info(struct RNAplfold_args_info *args_info)
{
  ...
  args_info->winsize_help = RNAplfold_args_info_detailed_help[6] ;
  args_info->span_help = RNAplfold_args_info_detailed_help[7] ;
  args_info->cutoff_help = RNAplfold_args_info_detailed_help[8] ;
  args_info->print_onthefly_help = RNAplfold_args_info_detailed_help[9] ;
  args_info->ulength_help = RNAplfold_args_info_detailed_help[10] ;
  args_info->opening_energies_help = RNAplfold_args_info_detailed_help[11] ;
  args_info->plex_output_help = RNAplfold_args_info_detailed_help[12] ;
  args_info->noconv_help = RNAplfold_args_info_detailed_help[13] ;
  args_info->temp_help = RNAplfold_args_info_detailed_help[15] ;
  args_info->noTetra_help = RNAplfold_args_info_detailed_help[16] ;
  args_info->dangles_help = RNAplfold_args_info_detailed_help[17] ;
  args_info->noLP_help = RNAplfold_args_info_detailed_help[19] ;
  args_info->noGU_help = RNAplfold_args_info_detailed_help[21] ;
  args_info->noClosingGU_help = RNAplfold_args_info_detailed_help[22] ;
  args_info->paramFile_help = RNAplfold_args_info_detailed_help[23] ;
...
static void print_help_common(void) {
  ...
  if (strlen(RNAplfold_args_info_purpose) > 0)
    printf("\n%s\n", RNAplfold_args_info_purpose);

  if (strlen(RNAplfold_args_info_usage) > 0)
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVW:L:c:ou:OT:4d:P:be:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'W':	/* Average the pair probabilities over windows of given size\n\n.  */
          ...
          break;
        case 'L':	/* Set the maximum allowed separation of a base pair to span. I.e. no pairs (i,j) with j-i > span will be allowed. Defaults to winsize if parameter is omitted\n\n.  */
        ...
        case 'o':	/* Save memory by printing out everything during computation.\nNOTE: activated per default for sequences over 1M bp.\n\n.  */
          ...
          break;
        case 'u':	/* Compute the mean probability that regions of length 1 to a given length are unpaired. Output is saved in a _lunp file.\n\n.  */
          ...
          break;
        case 'O':	/* Switch output from probabilities to their logarithms, which are NOT exactly the mean energies needed to the respective stretch of bases!\nNOTE: This actives -u option.\n\n.  */
