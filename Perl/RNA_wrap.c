...
extern char *pack_structure(const char *);
extern char *unpack_structure(const char *);
extern short *make_pair_table(const char *);
extern int bp_distance(const char *,const char *);
...
XS(_wrap_perl5_RNA_var_init) {
    ...
    sv = perl_get_sv("temperature",TRUE | 0x2);
    sv_setnv(sv,(double)temperature);
    ...
    sv = perl_get_sv("do_backtrack",TRUE | 0x2);
    sv_setiv(sv,(IV)do_backtrack);
    ...
    sv = perl_get_sv("noLonelyPairs",TRUE | 0x2);
    sv_setiv(sv,(IV)noLonelyPairs);
    swig_create_magic(sv,"noLonelyPairs", MAGIC_CAST MAGIC_CLASS _wrap_set_noLonelyPairs, MAGIC_CAST MAGIC_CLASS _wrap_val_noLonelyPairs);
    sv = perl_get_sv("backtrack_type",TRUE | 0x2);
    ...
    sv = perl_get_sv("aligned_line",TRUE | 0x2);
    ...
    sv = perl_get_sv("cost_matrix",TRUE | 0x2);
    sv_setiv(sv,(IV)cost_matrix);
    ...
    sv = perl_get_sv("rna_plot_type",TRUE | 0x2);
    sv_setiv(sv,(IV)rna_plot_type);
    swig_create_magic(sv,"rna_plot_type", MAGIC_CAST MAGIC_CLASS _wrap_set_rna_plot_type, MAGIC_CAST MAGIC_CLASS _wrap_val_rna_plot_type);
    XSRETURN(1);
}
#ifdef __cplusplus
extern "C"
