/*
  ...
  gengetopt -i RNALfold.ggo --file-name=RNALfold_cmdl --include-getopt --default-optional --func-name=RNALfold_cmdline_parser --arg-struct-name=RNALfold_args_info
...
const char *RNALfold_args_info_usage = "Usage: RNALfold [OPTIONS]...";
...
const char *RNALfold_args_info_detailed_help[] = {
  ...
  "  -L, --span=INT             Set the maximum allowed separation of a base pair\n                               to span. I.e. no pairs (i,j) with j-i>span will\n                               be allowed.\n\n                                 (default=`150')",
...
init_full_help_array(void)
{
  ...
  RNALfold_args_info_full_help[8] = RNALfold_args_info_detailed_help[8];
  RNALfold_args_info_full_help[9] = RNALfold_args_info_detailed_help[9];
  RNALfold_args_info_full_help[10] = RNALfold_args_info_detailed_help[10];
  RNALfold_args_info_full_help[11] = RNALfold_args_info_detailed_help[11];
  RNALfold_args_info_full_help[12] = RNALfold_args_info_detailed_help[12];
  RNALfold_args_info_full_help[13] = RNALfold_args_info_detailed_help[13];
  RNALfold_args_info_full_help[14] = RNALfold_args_info_detailed_help[14];
  RNALfold_args_info_full_help[15] = RNALfold_args_info_detailed_help[15];
  RNALfold_args_info_full_help[16] = RNALfold_args_info_detailed_help[17];
  RNALfold_args_info_full_help[17] = RNALfold_args_info_detailed_help[19];
  RNALfold_args_info_full_help[18] = RNALfold_args_info_detailed_help[20];
  RNALfold_args_info_full_help[19] = RNALfold_args_info_detailed_help[21];
  RNALfold_args_info_full_help[20] = RNALfold_args_info_detailed_help[23];
  RNALfold_args_info_full_help[21] = RNALfold_args_info_detailed_help[25];
  RNALfold_args_info_full_help[22] = RNALfold_args_info_detailed_help[26];
  RNALfold_args_info_full_help[23] = 0; 
  
}

const char *RNALfold_args_info_full_help[24];
...
init_help_array(void)
{
  ...
  RNALfold_args_info_help[8] = RNALfold_args_info_detailed_help[8];
  RNALfold_args_info_help[9] = RNALfold_args_info_detailed_help[9];
  RNALfold_args_info_help[10] = RNALfold_args_info_detailed_help[10];
  RNALfold_args_info_help[11] = RNALfold_args_info_detailed_help[11];
  RNALfold_args_info_help[12] = RNALfold_args_info_detailed_help[12];
  RNALfold_args_info_help[13] = RNALfold_args_info_detailed_help[13];
  RNALfold_args_info_help[14] = RNALfold_args_info_detailed_help[14];
  RNALfold_args_info_help[15] = RNALfold_args_info_detailed_help[15];
  RNALfold_args_info_help[16] = RNALfold_args_info_detailed_help[17];
  RNALfold_args_info_help[17] = RNALfold_args_info_detailed_help[19];
  RNALfold_args_info_help[18] = RNALfold_args_info_detailed_help[20];
  RNALfold_args_info_help[19] = RNALfold_args_info_detailed_help[21];
  RNALfold_args_info_help[20] = RNALfold_args_info_detailed_help[26];
  RNALfold_args_info_help[21] = 0; 
  
}

const char *RNALfold_args_info_help[22];
...
void init_args_info(struct RNALfold_args_info *args_info)
{
  ...
  args_info->span_help = RNALfold_args_info_detailed_help[6] ;
  args_info->noconv_help = RNALfold_args_info_detailed_help[7] ;
  args_info->zscore_help = RNALfold_args_info_detailed_help[10] ;
  args_info->gquad_help = RNALfold_args_info_detailed_help[11] ;
  args_info->temp_help = RNALfold_args_info_detailed_help[13] ;
  args_info->noTetra_help = RNALfold_args_info_detailed_help[14] ;
  args_info->dangles_help = RNALfold_args_info_detailed_help[15] ;
  args_info->noLP_help = RNALfold_args_info_detailed_help[17] ;
  args_info->noGU_help = RNALfold_args_info_detailed_help[19] ;
  args_info->noClosingGU_help = RNALfold_args_info_detailed_help[20] ;
  args_info->paramFile_help = RNALfold_args_info_detailed_help[21] ;
  args_info->nsp_help = RNALfold_args_info_detailed_help[23] ;
  args_info->energyModel_help = RNALfold_args_info_detailed_help[25] ;
...
static void print_help_common(void) {
  ...
  if (strlen(RNALfold_args_info_purpose) > 0)
    printf("\n%s\n", RNALfold_args_info_purpose);

  if (strlen(RNALfold_args_info_usage) > 0)
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVL:z::gT:4d:P:e:", long_options, &option_index);
