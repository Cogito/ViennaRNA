...
extern char bppm_symbol(float const *);
extern double mean_bp_dist(int);
...
XS(_wrap_bondT_get) {
    {
        ...
        ST(argvi) = sv_newmortal();
        SWIG_MakePtr(ST(argvi++), (void *) result, SWIGTYPE_p_bondT, SWIG_SHADOW|0);
        XSRETURN(argvi);
        fail:
        ;
    }
...
XS(_wrap_new_bondT) {
    {
        ...
        ST(argvi) = sv_newmortal();
        SWIG_MakePtr(ST(argvi++), (void *) result, SWIGTYPE_p_bondT, SWIG_SHADOW|SWIG_OWNER);
        XSRETURN(argvi);
        fail:
        ;
    }
